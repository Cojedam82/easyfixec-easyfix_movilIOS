package com.easyfix.client.widget;
...
public class CustomRadioGroup extends RadioGroup {
    ...
    public CustomRadioGroup(Context context) {
        ...
        mStrokeColor = resources.getColor(R.color.colorPrimary);
        mTintColor = resources.getColor(R.color.white);
        mUnCheckedTintColor = resources.getColor(R.color.colorPrimary);
        mMarginDp = (int) getResources().getDimension(R.dimen.sw_time_stroke_border);
        mCornerRadius = getResources().getDimension(R.dimen.sw_time_conner_radius);
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        try {
            mMarginDp = (int) typedArray.getDimension(
                    R.styleable.CustomRadioGroup_sc_border_width,
                    getResources().getDimension(R.dimen.sw_time_stroke_border));

            mCornerRadius = typedArray.getDimension(
                    R.styleable.CustomRadioGroup_sc_corner_radius,
                    getResources().getDimension(R.dimen.sw_time_conner_radius));

            mStrokeColor = typedArray.getColor(
                    R.styleable.CustomRadioGroup_sc_corner_radius_color,
                    getResources().getColor(R.color.colorPrimary));

            mTintColor = typedArray.getColor(
                    R.styleable.CustomRadioGroup_sc_tint_color,
                    getResources().getColor(R.color.white));

            mCheckedTextColor = typedArray.getColor(
                    R.styleable.CustomRadioGroup_sc_checked_text_color,
                    getResources().getColor(R.color.textColorSecondary));

            mUnCheckedTintColor = typedArray.getColor(
                    R.styleable.CustomRadioGroup_sc_unchecked_tint_color,
                    getResources().getColor(R.color.colorPrimary));
        } finally {
            typedArray.recycle();
        }
    ...
    private void updateBackground(View view) {
        ...
        maskDrawable.setStroke(mMarginDp, mStrokeColor);
    ...
    private class LayoutSelector {
        ...
        private int child;
        private final int SELECTED_LAYOUT = R.drawable.bg_switch_time_checked;
        private final int UNSELECTED_LAYOUT = R.drawable.bg_switch_time_unchecked;
        ...
        private int getChildren() {
            return CustomRadioGroup.this.getChildCount();
        }

        private int getChildIndex(View view) {
            return CustomRadioGroup.this.indexOfChild(view);
        }

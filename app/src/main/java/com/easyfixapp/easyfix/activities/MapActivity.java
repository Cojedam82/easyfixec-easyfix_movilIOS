...
public class MapActivity extends AppCompatActivity implements
    ...
    public void onConnectionFailed(@NonNull ConnectionResult connectionResult) {
        ...
        if (mResolvingError) {
            ...
            try {
                ...
                connectionResult.startResolutionForResult(MapActivity.this,
                        ...
                        case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                            ...
                            try {
                                ...
                                status.startResolutionForResult(
                                        MapActivity.this, Util.PLAY_SERVICES_REQUEST_CODE);
                            } catch (IntentSender.SendIntentException e) {
                                // Ignore the error.
                            }
                            break;
    ...
    private void showPlayServicesError(int errorCode) {
        ...
        GoogleApiAvailability.getInstance()
                .showErrorDialogFragment(MapActivity.this, errorCode, 1,
                        new DialogInterface.OnCancelListener() {
                            @Override
                            public void onCancel(DialogInterface dialog) {
                                //finish();
    ...
    private void createAddressTask(final Address address){
        Util.showLoading(MapActivity.this, getString(R.string.address_message_create_request));
